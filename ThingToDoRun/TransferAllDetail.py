...
csv_file_path = 'D:/NPVSCode/CrawlData/TripAdvisor_Crawl/FinalData/RemovedDuplicateTransferAllLinks.csv'
...
for link in links_list:
    ...
    df2.to_csv('../data/ThingToDo/Details/TransferAllDetails2.csv', encoding='utf-8', index=False)
    i += 1

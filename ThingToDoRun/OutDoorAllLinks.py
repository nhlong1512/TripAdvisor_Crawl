...
def crawl_one_page(url_page): 
    ...
    if links:
        ...
        csv_path = '../data/ThingToDo/Links/OutDoorAllLinks2.csv'
...
#Loop crawl pages
crawl_one_page("https://www.tripadvisor.com.vn/Attractions-g293921-Activities-c61-Vietnam.html")
for page_oa in range(2700,3660,30): 
    urlPage = 'https://www.tripadvisor.com.vn/Attractions-g293921-Activities-c61-oa' + str(page_oa) + '-Vietnam.html'
    crawl_one_page(urlPage)

df = pd.DataFrame(links_list, columns=['Link'])  # Tạo DataFrame với cột 'Link'
df.to_csv('../data/Food/Links/LinkPageProvinces2.csv', encoding='utf-8', index=False)
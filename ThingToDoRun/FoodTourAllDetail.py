...
csv_file_path = 'D:/KLTN/FinalData/RemovedDuplicateFoodTourAllLinks.csv'
...
for link in links_list:
    ...
    data_list.append({
        ...
        "Link_FoodTour": link_food_tour,
    }) 
    
    
    df2 = pd.DataFrame(data_list)
    df2.to_csv('../data/ThingToDo/Details/FoodTourAllDetails.csv', encoding='utf-8', index=False)
    i += 1

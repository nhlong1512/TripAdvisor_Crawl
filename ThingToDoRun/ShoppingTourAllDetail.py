...
csv_file_path = 'D:/NPVSCode/CrawlData/TripAdvisor_Crawl/FinalData/RemovedDuplicateShoppingTourAllLinks.csv'
...
for link in links_list:
    ...
    description = -1
    rank_of_province = -1
    link_shopping_tour = -1
    
    driver.get(link)
    time.sleep(1)
    link_shopping_tour = link
    ...
    try:
        ...
        try: 
            ...
            try: 
                img_url = driver.find_element("xpath", "/html/body/div[1]/main/div[1]/div[2]/div[2]/div[2]/div/div[1]/section[2]/div/div/div/div[1]/div/div/div[1]/div/div[2]/div/ul/li[2]/button/div/picture/img").get_attribute("src")
            except NoSuchElementException: 
                try: 
                    img_url = driver.find_element("xpath", "html/body/div[1]/main/div[1]/div[2]/div[2]/div[2]/div/div[1]/section[2]/div/div/div/div[1]/div/div/div[1]/div/div[2]/div/ul/li[1]/button/div/picture/img").get_attribute("srcset")
                except NoSuchElementException:
                    try: 
                        img_url = driver.find_element("xpath", "/html/body/div[1]/main/div[1]/div[2]/div[2]/div[2]/div/div[1]/section[2]/div/div/div/div[1]/div/div/div[1]/div/div[2]/div/ul/li[2]/button/div/picture/img").get_attribute("srcset")
                    except NoSuchElementException: 
                        try: 
                            img_url = driver.find_element("xpath", "/html/body/div[1]/main/div[1]/div[2]/div[2]/div[2]/div/div[1]/section[2]/div/div/div/div[1]/div/div/div[1]/div/div[2]/div/ul/li[2]/button/div/picture/img").get_attribute("srcset")
                        except NoSuchElementException:
    ...
    try: 
        ...
        try: 
            ...
            try: 
                ...
                try:
                    description = driver.find_element("xpath", "/html/body/div[1]/main/div[1]/div[2]/div[2]/div[2]/div/div[1]/section[7]/div/div/div/section/section/div[1]/div/div[5]/div/div[1]/div/div/div[4]/div[1]/div/span/span").text
                except NoSuchElementException:
    ...
    data_list.append({
        ...
        "Link_ShoppingTour": link_shopping_tour,
    }) 
    
    
    df2 = pd.DataFrame(data_list)
    df2.to_csv('../data/ThingToDo/Details/ShoppingTourAllDetails2.csv', encoding='utf-8', index=False)
    i += 1
